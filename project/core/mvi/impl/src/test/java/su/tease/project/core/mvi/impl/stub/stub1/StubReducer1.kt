...
class StubReducer1 : Reducer<StubState1> {
    ...
    override fun StubState1.onAction(action: PlainAction): StubState1 =
        when (action) {
    ...
    private fun StubState1.onUpdateIntValue(action: StubAction1.OnUpdateIntValue) = copy(intValue = action.intValue)

    private fun StubState1.onUpdateStringValue(action: StubAction1.OnUpdateStringValue) = copy(
