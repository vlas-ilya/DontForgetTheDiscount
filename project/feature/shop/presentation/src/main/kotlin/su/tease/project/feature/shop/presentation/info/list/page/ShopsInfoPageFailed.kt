...
@Composable
fun ShopsInfoPageFailed(
    onTryAgain: () -> Unit,
    modifier: Modifier = Modifier,
) {
    Column(modifier = modifier) {
        DFTextH1(
            text = stringResource(R.string.Shop_InfoListShopPage_ErrorResult_Placeholder),
            modifier = Modifier
                .fillMaxWidth()
        ...
        DFButton(
            label = stringResource(R.string.Shop_InfoListShopPage_Error_TryAgainButton),
            onClick = { onTryAgain() },
