...
@Composable
fun BankAccountsInfoPageFailed(
    onTryAgain: () -> Unit,
    modifier: Modifier = Modifier,
) {
    Column(modifier = modifier) {
        DFTextH1(
            text = stringResource(R.string.Bank_InfoListBankPage_ErrorResult_Placeholder),
            modifier = Modifier
                .fillMaxWidth()
        ...
        DFButton(
            label = stringResource(R.string.Bank_InfoListBankPage_Error_TryAgainButton),
            onClick = { onTryAgain() },
