...
## Bugs
 ...
 - [ ] (CACHEBACK-BUG-8) Не отображается дополнительная информация если у кэшбэка есть информация, но нет кодов
 - [ ] (CACHEBACK-BUG-9) Невозможно изменить банк у кэшбэка
