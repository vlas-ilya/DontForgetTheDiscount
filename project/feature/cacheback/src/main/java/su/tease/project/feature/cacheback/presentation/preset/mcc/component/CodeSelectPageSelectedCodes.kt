package su.tease.project.feature.cacheback.presentation.preset.mcc.component
...
fun CodeSelectPageSelectedCodes(
    ...
    DFFormElement(
        ...
        if (selectedCodes.isNotEmpty()) {
            ...
            DFText(
                text = stringResource(R.string.page_select_cache_back_codes_placeholder_selected),
